...
keep <- 
  c("PrgSrvc_IncrNum", "PrgSrvc_DcrsNum", "PrgSrvc_Suspend", "PrgSrvc_IncrSrvc", 
    ...
    "StaffingPlans_DK", "ContactUpdateName", "ContactUpdateTitle", 
    "ContactUpdateEmail", "Comments", "year3wt", "Staff_Fulltime_2023_imp", 
...
financials <-
   c("PplSrv_NumServed", "PplSrv_NumWait", "Staff_Fulltime_2022", 
    ...
    "Finance_Rev_Oth", "Reserves_Est", "CARES_Rcv_Est", "year3wt", 
