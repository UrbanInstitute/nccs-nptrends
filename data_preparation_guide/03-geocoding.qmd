...
This single column can now be passed into a geocoder of choice. In our case we use the Urban Institute's internal geocoder. The outputs are presented below.
...
We merge these results with our original survey data set. The geographic metadata can now be used to append additional census information in the next chapter.
